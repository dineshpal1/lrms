...
class UserController extends Controller
{
   ...
   // exit;
    	...
    	return view("assistant/assistant_dashboard",compact('pendingCount','approvedCount','month_expiry_count','next_expiry_count'));
    }
	...
	public function userList()
	{
		//$userList = user::orderBy('id', 'ASC')->where('role_id','!=' , 1)->get();
			...
			$userList=DB::table("users")
    			 ->select('users.id','name','email','role_id','raw_value','role_name')
