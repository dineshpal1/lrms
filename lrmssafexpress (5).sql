...
--
-- Host: localhost
-- Generation Time: Apr 11, 2020 at 05:10 PM
...
--
-- Table structure for table `dst_bank_branch_masters`
--

CREATE TABLE IF NOT EXISTS `dst_bank_branch_masters` (
  `id` int(11) NOT NULL,
  `dst_lrms_bank_masters_id` int(11) DEFAULT NULL,
...
--
-- Dumping data for table `dst_bank_branch_masters`
--

INSERT INTO `dst_bank_branch_masters` (`id`, `dst_lrms_bank_masters_id`, `bank_name`, `bank_branch_name`, `ifsc_code`, `bank_branch_address`) VALUES
(2, NULL, '2', 'chirag delhi-22', 'SBIN0016236', '840,chirag delhi'),
(3, NULL, '3', 'chirag delhi', 'SBIN0016890', 'delhi'),
(4, NULL, '1', 'civil lines', 'SBIN0016900', '220 civil lines allhabad');

-- --------------------------------------------------------

--
-- Table structure for table `dst_branch_area_masters`
--

CREATE TABLE IF NOT EXISTS `dst_branch_area_masters` (
  `id` int(11) NOT NULL,
  `area_name` varchar(100) NOT NULL
) ENGINE=InnoDB AUTO_INCREMENT=258 DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `dst_branch_area_masters`
--

INSERT INTO `dst_branch_area_masters` (`id`, `area_name`) VALUES
(1, 'AGARTALA'),
(2, 'AGRA'),
(3, 'AHMEDABAD'),
(4, 'AHMEDABAD CITY'),
...
CREATE TABLE IF NOT EXISTS `dst_city_masters` (
  `id` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `dst_lrms_bank_masters` (
  `id` int(11) NOT NULL,
...
(1, 1, NULL, NULL, NULL, 'MOHAN', '656757', 'MOH', 'BJQPK3677P', 'gf4fgdg', NULL, '', 'PATNA KANKARBAGH', 'AGARTALA', '0', '842001', 'mohan@gmail.com', '7982384254', '1580755704_smsmgtlogo.jpg', '1580755704_Downloadable-PDF-Button-PNG-Images.png', '1580755704_smsmgtlogo.jpg', 1, NULL, NULL, NULL, NULL, '2020-03-29 17:46:11', '2020-02-03 13:18:24'),
...
(9, 15, 'DEL012', NULL, NULL, 'prashant', '777', 'prashant', 'afqpv03675l', '07', NULL, NULL, 'vasant kunj', ' ', ' ', '110070', 'prashant@gmail.com', '9873834455', '1581415327_Sample-Cancelled-Cheques-SBI.png', '1581415327_index.jpg', '1581415327_1bc1f5d58d8f71f3beca8075feed11e5.png', 1, NULL, NULL, NULL, NULL, '2020-03-29 17:45:06', '2020-02-11 04:32:07'),
(10, 16, 'UTP001', NULL, NULL, 'Safiya Begum', '55555', 'safiya', 'BJQPK3677P', '06AZYPK3969P1Z3', '10%', NULL, 'h.no 100 seelam pur', ' ', ' ', '110031', 'sam@gmail.com', '100100100100', '1581775996_check.jpg', '1581775996_pancard.jpg', '1581775996_aadhaar.jpg', 0, NULL, NULL, NULL, NULL, '2020-03-29 17:45:01', '2020-02-15 08:43:16'),
...
(12, 16, 'UTP001', NULL, NULL, 'AK', '66666666', 'AK', 'BJQPK3677P', 'SDADAFDSDS', '10%', NULL, 'DELHI', ' ', ' ', '110070', 'test@gmail.com', '798238255', ' ', ' ', ' ', 1, NULL, NULL, NULL, NULL, '2020-03-29 17:44:10', '2020-02-16 07:01:07'),
...
(14, 17, 'DEL013', NULL, NULL, 'viraT', '25', 'virat kohli', 'BJQPK3677P', '06AZYPK3969P1Z3', '10%', NULL, 'bandra', ' ', ' ', '700100', 'kohli@yahoo.com', '25252525', '1581883799_check.jpg', '1581883799_pancard.jpg', '1581883799_aadhaar.jpg', 1, NULL, NULL, NULL, NULL, '2020-03-29 17:44:04', '2020-02-16 14:39:59'),
...
(21, 22, 'HAR001', NULL, NULL, 'ANKIT', ' 23', 'ANKIT SHARMA', 'AMFPK7654R', '08AMHYG5987H1ZF', '10', 'FARMER', 'RZF123, GALI NO12, KKKKKKKKKKKKKKKKFFFFFFFFFFFFFFFFFFFFFFFFFFWWWWWWWWWWWWWWWW,', 'ALWAR', '0', '110045', 'P@P.COM', '987654321', '1582105033_Sample-Cancelled-Cheques-SBI.png', '1582105033_Pan4.png', '1582105033_AADHAAR.jpg', 1, NULL, NULL, NULL, NULL, '2020-03-29 17:43:42', '2020-02-19 04:07:13'),
(22, 22, 'HAR001', NULL, NULL, 'RAHUL', ' 24', 'RAHUL SINGHANIA', 'AMSOK7654R', ' ', '0', '', 'STREET NO98', 'DELHI', 'DELHI', '110037', 'Y@YAHOO.COM', '3R22252525', ' ', ' ', ' ', 1, NULL, NULL, NULL, NULL, '2020-03-29 17:43:48', '2020-02-19 04:17:55'),
...
(36, 30, 'MHG001', NULL, NULL, 'RAHUL SINGHANIA', ' 326', 'RAHUL SINGHANIA', 'AMKJH7654R', '07AMJHY9876T1ZF', '10%', 'OWN BUSINESS', 'F-88, STREET NO.21, RAJ NAGAR, SADH NAGAR, PALAM COLONY,', 'AGARTALA', '0', '123456', 'P@P.COM', '987654321', '1582871976_PAN COPY.jpg', '1582871976_PAN COPY.jpg', '1582871976_AADHAAR.jpg', 1, NULL, NULL, NULL, NULL, '2020-04-09 11:05:16', '2020-02-28 01:09:36'),
(37, 30, 'MHG001', NULL, NULL, 'AMIT SACHDEVA', '678', 'AMIT SACHDEVA', 'AMKJH7654R', '09AMKJH7654R1ZF', '10%', 'FARMER', 'Y-98, PASCHIM MARG', 'New Delhi', 'DELHI', '110037', 'Q@WER.COM', '1234567890', '1582872250_PAN COPY.jpg', '1582872250_PAN COPY.jpg', '1582872250_AADHAAR.jpg', 1, NULL, NULL, NULL, NULL, '2020-04-09 11:05:26', '2020-02-28 01:14:10'),
(38, 32, 'JKH001', NULL, NULL, 'rahul sharma', '87686', 'rahul sharma', 'QWEPO9876T', '32AQZPD6788P1ZP', '10%', 'FARMER', 'f-98, street no.2', 'JAMMU', 'JAMMU AND KASHMIR', '123432', 'pawan@yahoo.com', '9876543210', '1584260624_Warehouse Image.jpg', ' ', '1584260624_Warehouse Image.jpg', 1, NULL, NULL, NULL, NULL, '2020-04-09 11:05:31', '2020-03-15 02:53:44'),
(39, 32, 'JKH001', NULL, NULL, 'amit', '3424', 'amit', 'KJHGF8765T', '32AQZPD6788P1ZP', '10%', 'JOB', 'h54', 'JAMMU', 'JAMMU AND KASHMIR', '123212', 'p@p.com', '987654321', '1584261081_Warehouse Image.jpg', ' ', '1584261081_Warehouse Image.jpg', 1, NULL, NULL, NULL, NULL, '2020-04-09 11:05:36', '2020-03-15 03:01:21'),
...
(42, NULL, ' ', NULL, NULL, 'SEEMA', '99900', 'SEEMA SINGH', 'BJQPK3677P', '', '10%', NULL, 'POKHRA', ' ', ' ', '110040', 'seema@yahoo.com', '258258', ' ', ' ', ' ', 1, NULL, NULL, NULL, NULL, '2020-03-29 17:47:17', '2020-03-15 10:18:18'),
(43, NULL, ' ', NULL, NULL, 'DONALD TRUMP', '12306', 'TRUMPH', 'BJQPK3677P', '', '10%', NULL, 'PRESIDENT HOUESE', ' ', ' ', '110041', 'trumph@gmail.com', '25582582', ' ', ' ', ' ', 1, NULL, NULL, NULL, NULL, '2020-03-29 17:47:08', '2020-03-15 11:41:02'),
...
(45, 33, 'UTP004', NULL, NULL, 'JHON', '12309', 'JHON', ' ', ' ', '10%', 'FORMING', 'Z-200 INDRA NAGAR', 'AGARTALA', '0', '233600', 'JHON@GMAIL.COM', '052022222', ' ', ' ', ' ', 1, NULL, NULL, NULL, NULL, '2020-03-29 17:46:45', '2020-03-16 10:00:40'),
(46, 33, 'UTP004', NULL, NULL, 'alex', '12308', 'alex', 'BJQPK3677P', '07BFYPC7011R1ZS', '10%', 'FORMING', '100  indra nagar', 'LUCKNOW', 'UTTAR PRADESH', '233500', 'alex@gmail.com', '05202222222', ' ', ' ', ' ', 1, NULL, NULL, NULL, NULL, '2020-03-29 17:46:51', '2020-03-16 10:07:42'),
(47, 35, 'DEL017', NULL, NULL, 'ap singh', '12307', 'ap', '', 'GSTIN', '10%', 'JOB', '220 uttam nagar', 'DELHI', 'DELHI', '100041', 'ap@gmail.com', '7777777777', ' ', ' ', ' ', 1, NULL, NULL, NULL, NULL, '2020-03-29 17:46:57', '2020-03-18 07:24:37'),
(48, 36, 'DEL018', NULL, NULL, 'hghj', '6546', 'Ram paratp', '', 'GSTIN', '10%', 'BUSINESS', 'delhi', 'DELHI', 'DELHI', '110070', 'test@gmail.com', '7982384543', ' ', ' ', ' ', 1, NULL, NULL, NULL, NULL, '2020-03-23 15:39:45', '2020-03-23 15:39:45');
...
CREATE TABLE IF NOT EXISTS `dst_lrms_dtls_documents` (
  `id` int(11) NOT NULL,
...
(111, 36, NULL, 0, 0, '1584977786_PAN_Card.jpg', NULL, NULL, '2020-03-23 15:36:26', '2020-03-23 15:36:26');
...
CREATE TABLE IF NOT EXISTS `dst_lrms_factsheet_agreement_documents` (
  `id` int(11) NOT NULL,
  `dst_lrms_master_id` int(11) DEFAULT NULL,
...
--
-- Table structure for table `dst_lrms_fusion_call_payables_payments`
--

CREATE TABLE IF NOT EXISTS `dst_lrms_fusion_call_payables_payments` (
  `id` int(11) NOT NULL,
  ...
  `PaymentFileReference` varchar(100) DEFAULT NULL,
  `PaymentProcessRequest` varchar(100) DEFAULT NULL,
  ...
  `PayeeSite` varchar(50) DEFAULT NULL,
  `PaymentMethodCode` varchar(50) DEFAULT NULL,
  `PaymentMethod` varchar(50) DEFAULT NULL,
  `ClearingDate` varchar(100) DEFAULT NULL,
  `ClearingAmount` varchar(100) DEFAULT NULL,
  `SupplierNumber` bigint(20) DEFAULT NULL,
  `RemitToAccountNumber` text,
  `VoucherNumber` text,
  `CreationDate` varchar(200) DEFAULT NULL,
  `CreatedBy` varchar(100) DEFAULT NULL,
  `LastUpdatedBy` varchar(100) DEFAULT NULL,
  `LastUpdateDate` varchar(200) DEFAULT NULL,
  `LastUpdateLogin` varchar(200) DEFAULT NULL,
  `api_call_date` date DEFAULT NULL
...
CREATE TABLE IF NOT EXISTS `dst_lrms_masters` (
  ...
  `branch_area` varchar(50) DEFAULT NULL,
  ...
  `factsheet_premises_photos` text,
  ...
  `rental_past_history` mediumtext,
  `comment` mediumtext,
  `status` tinyint(2) NOT NULL DEFAULT '1',
  `approve_status` tinyint(2) NOT NULL DEFAULT '0' COMMENT '0=Pending, 1=Approved ,2=Reject',
  `approve_status_remarks` text,
  `created_by` varchar(100) DEFAULT NULL,
  `created_date` date DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `dst_lrms_rent_agreements` (
  `id` int(11) NOT NULL,
  `dst_lrms_master_id` int(11) DEFAULT NULL,
  `factsheet_code` varchar(30) DEFAULT NULL,
...
(31, 36, 'DEL018', '2020-03-24', '2021-12-17', 'FGF GFDG GFGH', 'JAMMU AND KASHMIR', '110070', '42.00', 'Sq.Feet', '20', '10', 8000.00, NULL, 160000.00, 5000.00, '0 Month', '1', NULL, NULL, NULL, NULL, NULL, NULL, '2020-03-23 15:36:26', '2020-03-23 15:36:26'),
(32, 37, 'GUJ002', '2020-03-29', '2021-05-23', 'DELHI  DELHI', 'DELHI', '110070', '35.00', 'Sq.Feet', '13', '10', 4000.00, NULL, 52000.00, 6000.00, '0 Month', '1', NULL, NULL, NULL, NULL, NULL, NULL, '2020-03-29 17:19:56', '2020-03-29 17:19:56');
...
CREATE TABLE IF NOT EXISTS `dst_lrms_state_masters` (
  `id` int(11) NOT NULL,
...
(48, 36, 'DEL018', 48, NULL, 'ram paratp', 'mahipalpur', 'Escrow', 'icici', 'mahipalpur', 'hghghj', '110098765432', 'icic1008976', NULL, 1, NULL, NULL, NULL, NULL, '2020-03-23 15:39:45', '2020-03-23 15:39:45');
...
(48, 36, 'DEL018', 48, 2000.00, 2000.00, 8000.00, 2000.00, NULL, NULL, NULL, NULL, NULL, NULL, 'no remarks', NULL, 1, NULL, NULL, NULL, NULL, '2020-03-23 15:39:45', '2020-03-23 15:39:45');
...
CREATE TABLE IF NOT EXISTS `dst_region_masters_v1` (
  `id` int(11) NOT NULL,
  `region_id` varchar(9) DEFAULT NULL,
  `region_code` varchar(8) DEFAULT NULL,
  `name` varchar(32) DEFAULT NULL
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `role_id` tinyint(3) DEFAULT '2' COMMENT '1=admin,2=fieldstaff',
  `remember_token` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `raw_value` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
...
INSERT INTO `users` (`id`, `name`, `email`, `email_verified_at`, `password`, `role_id`, `remember_token`, `raw_value`, `created_at`, `updated_at`) VALUES
...
(2, 'Mayank', 'mayank@digitalissystem.com', NULL, '$2y$10$OvVzg1Gif6cq5g7CcZmZtOXbqX3O9G1QTeFzrKM8PEZCFAHrgbPLy', 1, 'BvMjMJOovcIhCd0gresBiwgMO5bseoWdfJworD4IVcbvEONGHm6DSLAEFbZF', '', '2020-01-09 04:42:30', '2020-01-09 04:42:30'),
...
(4, 'admin', 'admin@gmail.com', NULL, '$2y$10$OTESYPWWj3K3OeNd8jTWiexaNYQBV.idTkpOF8zHXqfeH2oVB.X6O', 1, NULL, '', '2020-01-30 13:06:03', '2020-01-30 13:06:03'),
...
(9, 'Dinesh', 'dinesh.pal@digitalissystem.com', NULL, '$2y$10$BsKiLcGvuWQNMvC5qgOnneh7J1ZYpjSaLtyxshRBzdrxm0eXvLMp6', 1, NULL, '', '2020-03-18 06:43:50', '2020-03-18 06:43:50'),
(10, 'arvind', 'arvindkr.singh099@gmail.com', NULL, '$2y$10$/HaVah2wvIOvBECJJIjR6eF.HAHbi69qkyfDg.nNrl8xX/F.txGea', 2, NULL, 'OtoaDvKM', '2020-03-28 02:05:14', '2020-03-28 02:05:14'),
(12, 'arvind', 'arvindkr.singh09@gmail.com', NULL, '$2y$10$0MbfdEmcQQklKaZf49MKluvqorXHyiySEey59nPvcoIdmugNSyyKq', 2, 'K5NGDrQOpP3RdllG46E87SsCdZ19Ac07F6Q9FUNQ', '12345678', '2020-03-28 02:11:59', '2020-03-28 06:29:14'),
(13, 'arvind', 'arvindkr.singh09090@gmail.com', NULL, '$2y$10$duyfo61I/H/JtZkP5KHBjOkaeflQUD14BqGG46GM33U4XCIDb1pFu', 2, 'K5NGDrQOpP3RdllG46E87SsCdZ19Ac07F6Q9FUNQ', 'r0mQkx6B', '2020-03-28 02:37:01', '2020-03-28 02:37:01'),
(14, 'Assistant', 'assistant@gmail.com', NULL, '$2y$10$PNyJeeAaomizWJIdM5rb9.wWNp4FL74fl.il11XQ.pnW2JMulPOpG', 3, 'gzkzZM6ZF24jrIxGdYQxXdAflVyxOFw7Ao67yy78WvzEaXuIzkGwdPB2jdQM', '9nIkoexC', '2020-04-09 10:18:55', '2020-04-09 10:18:55'),
(15, 'Manager', 'manager@gmail.com', NULL, '$2y$10$u8qOofAQH1Ds/VuUhYgVAuh4JvNWBPqW0vtbVa9vV7vqdj.gSfp9a', 4, 'icSDADIzp6ewVO1B58YJFlPvyRzmsoORy0tXG772', 'waCiINHm', '2020-04-09 10:19:26', '2020-04-09 10:19:26');
...
--
-- Indexes for table `dst_bank_branch_masters`
--
ALTER TABLE `dst_bank_branch_masters`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `dst_branch_area_masters`
--
ALTER TABLE `dst_branch_area_masters`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `dst_bank_branch_masters`
--
ALTER TABLE `dst_bank_branch_masters`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=8;
--
-- AUTO_INCREMENT for table `dst_branch_area_masters`
--
ALTER TABLE `dst_branch_area_masters`
