    ...
    <div class="main-panel">
      <div class="content">
           ...
           <!--  <form name="factSheetForm" id="factSheetForm"> -->
              <form name='form2'  method="POST" action="{{ url('saveBanks') }}" id="add_banks">
              @csrf
        ...
        <br/>
           <div class="card-action">
                      ...
                      <button type="button" class="btn btn-danger" onClick="window.location='{{url("allBank")}}'" >Cancel</button>
