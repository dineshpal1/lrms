            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header">
                  <h4 class="card-title" style="margin-bottom:0px;">Agreement Renewed List <a class="btn btn-success btn-sm pull-right" href="{{url('FactsList')}}" >Back</a></h4>
                </div>
                <div class="card-body">
                  <div class="table-responsive">
                    <table id="basic-datatables" class="display table table-striped table-hover" >
                      ...
                      <tbody>
                           <?php $i=1;?>
                        @foreach ($renewedList as $renewed)
                        <tr>
						  <td><?php echo $i++; ?></td>
                          <td>{{$renewed->factsheet_code}}</td>
                          <td>{{$renewed->total_month_rent}}</td>
                          <td>{{$renewed->revised_rent}}</td>
						  <td>{{$renewed->monthly_increase}}</td>
						  <td><?php echo $newtext1 = wordwrap($renewed->rental_past_history, 20, "\n", true);?></td>
						  <td><?php echo $newtext2 = wordwrap($renewed->action_taken, 20, "\n", true);?></td>
						  <td>{{$renewed->no_of_renewal}}</td>
						  						  <td>{{$renewed->no_of_renewal}}</td>
						  <td>{{$renewed->no_of_renewal}}</td>
						  <td>{{$renewed->no_of_renewal}}</td>
						  <td>{{$renewed->no_of_renewal}}</td>
