            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header">
                  <h4 class="card-title">Agreement To Be Renew List ( Total : {{$factDatalist->count('id')}} ) <a class="btn btn-success btn-sm pull-right" href="{{url('FactsList')}}">Back</a></h4>
                </div>
                <div class="card-body">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>{{$facts->agreement_period_end}}</td>
                           ...
                           <td><a href="{{action('FactSheetController@agreementRenew', $facts->id)}}">Renew</a></td>
