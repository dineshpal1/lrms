            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header">
                  <h4 class="card-title">Facts List  ( Total : {{$factDatalist->count('id')}} )</h4>
                </div>
                <div class="card-body">
                      ...
                      <tbody>
                        ...
                        <tr style="text-align:left;">
						  ...
						  <td>{{ $facts->branch_location}}</td>
                           ...
                           <td><a href="{{action('FactSheetController@noOfOwner', $facts->id)}}">{{$facts->no_of_owner}}</a>|<button class="btn btn-success btn-sm" data-id="{{$facts->id}}" data-toggle="modal" data-target="#modalForm" style="padding-top: 2px;
    height: 21px;">Add
</button></td>
                           ...
                           <td><a href="{{action('FactSheetRenewController@uploadFactsheet', $facts->id)}}">Upload <br>Agreement</td>
                        </tr>
                      @endforeach
