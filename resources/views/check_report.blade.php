...
<div class="main-panel">
   <div class="content">
             <form name='form1'  method="POST" action="{{ url('checkSupplierData') }}" enctype="multipart/form-data" id="create_form">
              @csrf
