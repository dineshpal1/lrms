                     ...
                     <div class="row">
                      ...
                      <div class="card-title">Measurement & Flooring Details </div>
                       ...
                       <label for="name">Length (with decimal point)</label>
                        <input type="text" id="length" name="length"  class="form-control error" aria-required="true" value="0.0" onblur="checkValue()">
                        </div>                   
                        </div>
                        <div class="col-2">
                        <div class="form-group">
                    ...
                    <select id="height_unit" name="height_unit" class="form-control" aria-required="true">
                     ...
                     <div class="row">
                       ...
                       <label for="name">Breadth (with decimal point)</label>
                        <input type="text" id="breadth" name="breadth"  class="form-control error" aria-required="true" value="0.0">
                        </div>                   
                        </div>
                        <div class="col-2">
                        <div class="form-group">
