...
.form-group label {
  ...
  display: block;
    ...
    <div class="main-panel">
      <div class="content">
        <form action="{{url('saveFactSheetPart2')}}" method="post" enctype="multipart/form-data" id="form2">
        {{ csrf_field() }}
      ...
      $ownerCount = $ownerlist->count() + 1;
                  ...
                  <div class="card">
                    <div class="card-header">
                      <div class="card-title">Owner Details {{ $ownerCount }}
                    ...
                    <div class="card-body">
                      ...
                      <!--   <label id="name-error" class="error" for="name">This field is required.</label> -->
                       @if ($errors->has('payee_name'))
                        <span class="text-danger">{{ $errors->first('payee_name') }}</span>
                       @endif
                    </div>
                        </div>
                    ...
                    <div class="col-4">
                       <div class="form-group">
                        ...
                        <span class="text-danger">{{ $errors->first('landlord_address') }}</span>
                       @endif
                        </div>
                        </div>
                   ...
                   <div class="form-group">
                      ...
                      <div class='validation' style='color:red;margin-bottom: 20px;display:none'>Enter valid Pan Card Number</div>
                       @if ($errors->has('pan_of_payee'))
                        <span class="text-danger">{{ $errors->first('pan_of_payee') }}</span>
                       @endif
                        <!-- <label id="name-error" class="error" for="name">This field is required.</label> -->
                    </div>
                        </div>
                   ...
                   <div class="row">
                       ...
                       @if ($errors->has('gstn_of_payee'))
                        <span class="text-danger">{{ $errors->first('gstn_of_payee') }}</span>
                       @endif
                       <!--  <label id="name-error" class="error" for="name">This field is required.</label> -->
                    </div>
                        </div>
       ...
       <input type="hidden" name="totalRentalSum" id="totalRentalSum" value="">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="refundable_security_deposits" name="refundable_security_deposits" class="form-control error" aria-required="true">
                         @if ($errors->has('refundable_security_deposits'))
                        <span class="text-danger">{{ $errors->first('refundable_security_deposits') }}</span>
                       @endif
                    </div>
                        </div>
                        ...
                        <input type="text" id="advances" name="advances" class="form-control  error" aria-required="true">
                          @if ($errors->has('advances'))
                        <span class="text-danger">{{ $errors->first('advances') }}</span>
                       @endif
                        </div>
                        </div>
                    ...
                    <div class="row">
                      <input type="hidden" name="total_monthly_rent" id="total_monthly_rent" value="{{ $monthlyRental }}">
                      <input type="hidden" name="totalRentalSum" id="totalRentalSum" value="{{ $totalRentalSum }}">
                          <div class="col-4">
                       <div class="form-group">
                        <label for="name">Monthly  Rent {{ $totalRentalSum}}</label>
                        <input type="text" id="month_rent" name="month_rent" class="form-control  error" aria-required="true" onblur="checkValue()">
                        @if ($errors->has('month_rent'))
                        <span class="text-danger">{{ $errors->first('month_rent') }}</span>
                       @endif
                      </div>
                     </div>
                        <div class="col-4">
                        ...
                        <input type="text" id="advance_deduction" name="advance_deduction" class="form-control  error" aria-required="true">
                         @if ($errors->has('advance_deduction'))
                        <span class="text-danger">{{ $errors->first('advance_deduction') }}</span>
                       @endif
                        </div>
                        </div>
               ...
               <!--<div class="row">
                    ...
                    <div class="row">
                     ...
                     <div class="col-4">
                      <div class="form-group">
                        ...
                        @if ($errors->has('payee_name_for_rent'))
                        <span class="text-danger">{{ $errors->first('payee_name_for_rent') }}</span>
                       @endif
                        <!-- <label id="name-error" class="error" for="name">This field is required.</label> -->
                    </div>
                     </div>
                 ...
                 <label for="name">Upload Owner Document</label>
                      ...
                      <input type="file" class="form-control" name="owner_cancelled_cheque_copy" id="owner_cancelled_cheque_copy"/>
                       @if ($errors->has('owner_cancelled_cheque_copy'))
                        <span class="text-danger">{{ $errors->first('owner_cancelled_cheque_copy') }}</span>
                       @endif
                      </div>
                      </div>
                       <div class="col-6">
                      ...
                      <input type="file" class="form-control" name="owner_pan_card_copy" id="owner_pan_card_copy"/>
                       @if ($errors->has('owner_pan_card_copy'))
                        <span class="text-danger">{{ $errors->first('owner_pan_card_copy') }}</span>
                       @endif
                      </div>
                      </div>
                    </div> 
                     ...
                     <div class="row">
                      ...
                      <input type="file" class="form-control" name="owner_aadhaar_card_copy" id="owner_aadhaar_card_copy"/>
                       @if ($errors->has('owner_aadhaar_card_copy'))
                        <span class="text-danger">{{ $errors->first('owner_aadhaar_card_copy') }}</span>
                      @endif
                      </div>
                      </div>
