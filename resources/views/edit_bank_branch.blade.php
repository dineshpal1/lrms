...
<form name='form2'  method="POST" action="{{ url('updateBankBranch',$editBankBranch->id) }}" id="add_banks">
@csrf
...
aria-controls="home" aria-selected="true">Edit Bank Branch </a>
...
<option value="{{$bank->id}}" <?php if($editBankBranch->bank_name==$bank->id) echo "selected";?>>{{$bank->bank_name}}</option>
@endforeach
</select>
...
<input type="text" class="form-control" name="bank_branch_name"  value="{{$editBankBranch->bank_branch_name}}" style="text-transform: uppercase" />
...
<input type="text" class="form-control" name="ifsc_code" value="{{$editBankBranch->ifsc_code}}" style="text-transform: uppercase" />
...
<textarea class="form-control" name="bank_branch_address" style="text-transform: uppercase"   >{{$editBankBranch->bank_branch_address}}</textarea>
...
<input type="submit" class="btn btn-success" value="Update Bank Branch">
