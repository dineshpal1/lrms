                        ...
                        <table id="basic-datatables" class="display table table-striped table-hover" >
                           ...
                           <tbody>
                              ...
                              <tr>
								 ...
								 <td>{{$invoiceData['InvoiceGroup']}}</td>
								 <td>{{$invoiceData['InvoiceType']}}</td>
								 <td>{{$invoiceData['Supplier']}}</td>
								 <td>{{$invoiceData['SupplierNumber']}}</td>
								 <td>{{$invoiceData['SupplierSite']}}</td>
								 <td>{{$invoiceData['SupplierSite']}}</td>
								 <td>{{$invoiceData['AccountingDate']}}</td>
								 <td>{{$invoiceData['InvoiceSource']}}</td>
								 <td>{{$invoiceData['InvoiceGroup']}}</td>
								 <td>{{$invoiceData['PayGroup']}}</td>
								 <td>{{$invoiceData['PaymentTerms']}}</td>
								 <td>{{$invoiceData['TermsDate']}}</td>
								 <td>{{$invoiceData['PaymentMethodCode']}}</td>
								 <td>{{$invoiceData['PaymentMethod']}}</td>
								 <td>{{$invoiceData['ValidationStatus']}}</td>
								 <td>{{$invoiceData['ApprovalStatus']}}</td>
								 <td>{{$invoiceData['PaidStatus']}}</td>
								 <td>{{$invoiceData['AccountingStatus']}}</td>
								 <td>{{$invoiceData['CanceledDate']}}</td>
								<td>{{$invoiceData['CanceledBy']}}</td>
								 <td>{{$invoiceData['CreationDate']}}</td>
								 <td>{{$invoiceData['CreatedBy']}}</td>
								 <td>{{$invoiceData['LastUpdatedBy']}}</td>
								<td>{{$invoiceData['LastUpdateDate']}}</td>
                                <td>{{$invoiceData['LastUpdateLogin']}}</td>
