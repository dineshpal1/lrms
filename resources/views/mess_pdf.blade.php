...
foreach($ownerData as $owner)
{
	...
	//exit;
	echo "<strong>";echo "\t"; echo $owner['property_owner_name']; echo "</strong>"; echo "\t";echo "having its residence address at-";echo "\t"; echo "<strong>";echo "\t";echo $owner['property_owner_address']; echo ", \t"; echo $owner['property_owner_district']; echo "-";echo $owner['property_owner_postal_code']; echo ", \t"; echo $owner['property_owner_state']; echo "</strong>"; echo ", \t";
}
...
AND<br>
M/S SAFEXPRESS PRIVATE LIMITED, 
...
<p align='justify'>WHEREAS The LESSOR is the absolute and rightful owner of the PREMISES situated at- <strong>".$factSheet[0]['premises_address'].", ".$factSheet[0]['premises_state']." PINCODE : ".$factSheet[0]['premises_pin_code']." </strong>having a covered area of <strong>".$factSheet[0]['premises_area']."</strong><strong>Sq.Fts. </strong> having full and lawful rights to let out the same at such terms and conditions as he may think of AND WHEREAS the LESSOR has agreed to let out and the LESSEE has agreed to take on lease the above said Property, hereinafter referred to as “THE PREMISES”.</p>
