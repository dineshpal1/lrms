  ...
  <div class="sidebar sidebar-style-2">			
    ...
    <h4 class="card-title">Latest Agreement Renewed List</h4>
    </div>
    <div class="card-body">
    ...
    <td><?php echo $newtext1 = wordwrap($renewed->rental_past_history, 50, "\n", true);?></td>
    <td><?php echo $newtext2 = wordwrap($renewed->action_taken, 50, "\n", true);?></td>
    <td>{{$renewed->no_of_renewal}}</td>
    <td>{{$renewed->agreement_period_start}}</td>
    <td>{{$renewed->agreement_period_end}}</td>
