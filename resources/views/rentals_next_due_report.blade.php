            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header">
				  ...
				  <a href="{{ url('/excelExportRentalNextDue')}}" >
                  ...
                  <div class="table-responsive">
                    <table id="basic-datatables" class="display table table-striped table-hover" >
                      ...
                      <tbody>
                        ...
                        @foreach ($rentalReport as $rental)
                        <tr>
						 <td><?php echo $i++; ?></td>
                          <td>{{$rental->region_code}}</td>
                          <td>{{$rental->city }}</td>
                          <td>{{$rental->branch_type}}</td>
                          <td>{{$rental->branch_code}}</td>
                           <td>{{$rental->property_owner_name}}</td>
                           <td>{{$rental->total_month_rent}}</td>
                           <td>{{$rental->premises_area}}</td>
						    <td>{{$rental->branch_occupancy_date}}</td>
				            <td>{{$rental->agreement_expired_on_next_month}}</td>
                           <td>{{$rental->premises_area}}</td>
                           <td>{{$rental->agreement_period_start}}</td>
                           <td>{{$rental->agreement_period_end}}</td>
                           <td>{{$rental->enhancement_clause}}</td>
                           <td>{{$rental->enhancement_clause}}</td>
                           <td>{{$rental->agreement_period_end}}</td>
                           <td>{{$rental->revised_rent}}</td>
                           <td><?php echo "Agreement"; ?></td>
						   <td>{{$rental->payment_system}}</td>
