    ...
    <div class="main-panel">
      <div class="content">
           ...
           <!--  <form name="factSheetForm" id="factSheetForm"> -->
              <form name='form2'  method="POST" action="<?php echo e(url('saveBranch')); ?>" id="addBranch">
              <?php echo csrf_field(); ?>
...
<?php endif; ?>
        ...
        <br/>
           <div class="card-action">
                      ...
                      <button type="button" class="btn btn-danger" onClick="window.location='<?php echo e(url("allBranch")); ?>'" >Cancel</button>
...
//Route::post("saveCity","All_Masters@saveCity");*/<?php /**PATH /var/www/html/lrms/resources/views/add_branch.blade.php ENDPATH**/ ?>