            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header">
				  ...
				  <a class="btn btn-success btn-lg pull-right" href="<?php echo e(url('addBranch')); ?>" >Add Branch</a>
                </div>
                <div class="card-body">
                 ...
                 <table id="basic-datatables" class="display table table-striped table-hover" >
                      ...
                      <tbody>
                        ...
                        <tr>
						           <td><?php echo $i++; ?></td>
									<td><?php echo e($row->branch_id); ?></td>
									<td><?php echo e($row->branch_code); ?></td>
									<td><?php echo e($row->branch_type); ?></td>
...
<?php /**PATH /var/www/html/lrms/resources/views/all_branch.blade.php ENDPATH**/ ?>