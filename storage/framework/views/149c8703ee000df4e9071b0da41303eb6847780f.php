			...
			<div class="sidebar-wrapper scrollbar scrollbar-inner">
				<div class="sidebar-content">
					...
					<ul class="nav nav-primary">
						...
						<?php endif; ?>
						<?php if(Auth::user()->role_id==1 || Auth::user()->role_id==3 || Auth::user()->role_id==4): ?>
						<li class="nav-item submenu">
    ...
    <div class="row">
        <div class="col-md-4 col-xl-3">
            <div class="card bg-c-blue order-card">
                ...
                <div class="card-block">
                    ...
                    <h6 class="m-b-20"><a href="<?php echo e(url('approvedList')); ?>">Total Approved</a></h6>
                    <h2 class="text-right"><i class="fa fa-rocket f-left"></i><span><a href="<?php echo e(url('approvedList')); ?>"><?php echo e($approvedCount); ?></a></span></h2>
        ...
        <div class="col-md-4 col-xl-3">
            <div class="card bg-c-green order-card">
                <div class="card-block">
                    <h6 class="m-b-20"><a href="<?php echo e(url('pendingList')); ?>">Total Pending Factsheet</a></h6>
                    <h2 class="text-right"><i class="fa fa-rocket f-left"></i><span><a href="<?php echo e(url('pendingList')); ?>"><?php echo e($pendingCount); ?></a></span></h2>
                    <!--<p class="m-b-0">Completed Orders<span class="f-right">351</span></p>-->
                </div>
            </div>
        </div>
        ...
        <div class="col-md-4 col-xl-3">
            <div class="card bg-c-yellow order-card">
                <div class="card-block">
                    <h6 class="m-b-20"><a href="<?php echo e(url('monthExpiry')); ?>">This Month Expiry</a>
                    </h6>
                    <h2 class="text-right"><i class="fa fa-refresh f-left"></i><span><a href="<?php echo e(url('monthExpiry')); ?>"><?php echo e($month_expiry_count); ?></a></span></h2>
                    <!--<p class="m-b-0">Completed Orders<span class="f-right">351</span></p>-->
                </div>
            </div>
        </div>
        ...
        <div class="col-md-4 col-xl-3">
            <div class="card bg-c-pink order-card">
                <div class="card-block">
                    <h6 class="m-b-20"><a href="<?php echo e(url('totalNextExpiry')); ?>">Total Next 90 Days Expiry</a></h6>
                    <h2 class="text-right"><i class="fa fa-credit-card f-left"></i><span><a href="<?php echo e(url('totalNextExpiry')); ?>"><?php echo e($next_expiry_count); ?></a></span></h2>
                    <!--<p class="m-b-0">Completed Orders<span class="f-right">351</span></p>-->
                </div>
            </div>
        </div>
				...
				<!--<div class="page-inner mt--5">
												...
												<table class="table">
													<tbody>
														<tr>
															<td>
																<div class="flag">
																	<img src="<?php echo e(asset('images/flags/id.png')); ?>" alt="indonesia">
																</div>
															</td>
															<td>Indonesia</td>
															<td class="text-right">
														...
														<tr>
															<td>
																<div class="flag">
																	<img src="<?php echo e(asset('images/flags/us.png')); ?>" alt="united states">
																</div>
															</td>
															<td>USA</td>
															<td class="text-right">
														...
														<tr>
															<td>
																<div class="flag">
																	<img src="<?php echo e(asset('images/flags/au.png')); ?>" alt="australia">
																</div>
															</td>
															<td>Australia</td>
															<td class="text-right">
														...
														<tr>
															<td>
																<div class="flag">
																	<img src="<?php echo e(asset('images/flags/ru.png')); ?>" alt="russia">
																</div>
															</td>
															<td>Russia</td>
															<td class="text-right">
														...
														<tr>
															<td>
																<div class="flag">
																	<img src="<?php echo e(asset('images/flags/cn.png')); ?>" alt="china">
																</div>
															</td>
															<td>China</td>
															<td class="text-right">
							...
							<div class="card">
								<div class="card-body">
									...
									<div class="card-list">
										...
										<div class="item-list">
											<div class="avatar">
												<img src="<?php echo e(asset('images/talha.jpg')); ?>" alt="..." class="avatar-img rounded-circle">
											</div>
											<div class="info-user ml-3">
												<div class="username">Talha</div>
												<div class="status">Front End Designer</div>
										...
										<div class="item-list">
											<div class="avatar">
												<img src="<?php echo e(asset('images/jm_denis.jpg')); ?>" alt="..." class="avatar-img rounded-circle">
											</div>
											<div class="info-user ml-3">
												<div class="username">Jimmy Denis</div>
												<div class="status">Graphic Designer</div>
					...
					<div class="row">
						...
						<?php echo $__env->make('layouts.userLayout.admin_footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php /**PATH /var/www/html/lrms/resources/views/assistant/assistant_dashboard.blade.php ENDPATH**/ ?>