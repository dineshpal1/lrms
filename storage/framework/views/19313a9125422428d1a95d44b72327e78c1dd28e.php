            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header">
                  <h4 class="card-title">Agreement To Be Renew List ( Total : <?php echo e($factDatalist->count('id')); ?> ) <a class="btn btn-success btn-sm pull-right" href="<?php echo e(url('FactsList')); ?>">Back</a></h4>
                </div>
                <div class="card-body">
                      ...
                      <thead>
                        <tr>
						 <th>Sr. No</th>
                          ...
                          <th>Agreement Period Start</th>
                           <th>Agreement Period End</th>
                          <th>Renew</th>
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td><?php echo e($facts->agreement_period_end); ?></td>
                           ...
                           <td><a href="<?php echo e(action('FactSheetController@agreementRenew', $facts->id)); ?>">Renew</a></td>

                           <!-- <td><a href="<?php echo e(action('FactSheetController@downloadPDF', $facts->id)); ?>">PDF</a></td>
    ...
    $(document).ready(function() {
      ...
      $('#addRowButton').click(function() {
        ...
        $('#addRowModal').modal('hide');
          ...
          <?php /**PATH /var/www/html/lrms/resources/views/agreement_to_be_renew_list.blade.php ENDPATH**/ ?>