            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header">
                  <h4 class="card-title">Total Pending Fact Sheet List  ( Total : <?php echo e($pendingList->count('id')); ?> )</h4>
                </div>
                <div class="card-body">
                  <div class="table-responsive">
                    <table id="basic-datatables" class="display table table-striped table-hover" >
                      ...
                      <tbody>
                           <?php $i=1;?>
                        <?php $__currentLoopData = $pendingList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $facts): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr style="text-align:left;">
						  <td><?php echo $i++; ?></td>
                          <td><?php echo e($facts->factsheet_code); ?></td>
						  <td><?php echo e($facts->branch_code); ?></td>
						  <td><?php echo e($facts->branch_location); ?></td>
						  <td><?php echo e($facts->branch_area); ?></td>
                         
                           <td><a href="<?php echo e(action('FactSheetController@noOfOwner', $facts->id)); ?>"><?php echo e($facts->no_of_owner); ?></a></td>
                           ...
                           <td>
							 ...
							 <button class="btn btn-success btn-default" style="background-color: #D5DBDB  !important;" data-id="<?php echo e($facts->id); ?>" data-toggle="modal" id="stus_<?php echo e($facts->approve_status); ?>" data-target="#modalForm2" style="padding-top: 2px;
							 ...
							 <input type="hidden" name="prevremarks" id="prevremarks_<?php echo e($facts->id); ?>" value="<?php echo e($facts->approve_status_remarks); ?>">
                           </td>
...
</script><?php /**PATH /var/www/html/lrms/resources/views/factsheet_pending_list.blade.php ENDPATH**/ ?>