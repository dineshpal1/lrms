    ...
    <div class="main-panel">
      <div class="content">
           ...
           <!--  <form name="factSheetForm" id="factSheetForm"> -->
              <form name='form2'  method="POST" action="<?php echo e(url('saveCity')); ?>" id="add_city">
              <?php echo csrf_field(); ?>
...
<?php endif; ?>
            ...
            <div class="col-md-6">
              <ul class="nav nav-tabs" id="myTab" role="tablist">
                <li class="nav-item">
                  <a class="nav-link active" id="home-tab" data-toggle="tab" href="#home" role="tab"
                    aria-controls="home" aria-selected="true">Add City </a>
             ...
             <div class="row">
                     ...
                     <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="add_city" style="text-transform: uppercase" />
        ...
        <br/>
           <div class="card-action">
                      ...
                      <button type="button" class="btn btn-danger" onClick="window.location='<?php echo e(url("allCity")); ?>'" >Cancel</button>
...
//Route::post("saveCity","All_Masters@saveCity");*/<?php /**PATH /var/www/html/lrms/resources/views/add_city.blade.php ENDPATH**/ ?>