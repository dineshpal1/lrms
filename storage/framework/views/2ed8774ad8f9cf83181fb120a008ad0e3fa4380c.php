            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header">
                  <h4 class="card-title">Facts List  ( Total : <?php echo e($factDatalist->count('id')); ?> )</h4>
                </div>
                <div class="card-body">
                  <div class="table-responsive">
                    <table id="basic-datatables" class="display table table-striped table-hover" >
                      ...
                      <tbody>
                           <?php $i=1;?>
                        <?php $__currentLoopData = $factDatalist; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $facts): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr style="text-align:left;">
						  ...
						  <td><?php echo e($facts->branch_location); ?></td>
                           ...
                           <td><a href="<?php echo e(action('FactSheetController@noOfOwner', $facts->id)); ?>"><?php echo e($facts->no_of_owner); ?></a>|<button class="btn btn-success btn-sm" data-id="<?php echo e($facts->id); ?>" data-toggle="modal" data-target="#modalForm" style="padding-top: 2px;
    height: 21px;">Add
</button></td>
                           ...
                           <td><a href="<?php echo e(action('FactSheetRenewController@uploadFactsheet', $facts->id)); ?>">Upload <br>Agreement</td>
                        </tr>
...
</script><?php /**PATH /var/www/html/lrms/resources/views/all_facts_list.blade.php ENDPATH**/ ?>