            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header">
                  <h4 class="card-title">All Bank Branch List  </h4>
				  <a class="btn btn-success btn-lg pull-right" href="<?php echo e(url('addBankBranch')); ?>" >Add Bank Branch</a>
                </div>
                <div class="card-body">
                 ...
                 <table id="basic-datatables" class="display table table-striped table-hover" >
                      ...
                      <tbody>
                           <?php $i=1;?>
                        <?php $__currentLoopData = $allBankBranches; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $branch): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
						           <td><?php echo $i++; ?></td>
									<td><?php echo e(strtoupper($branch->bank)); ?></td>
								    <td><?php echo e(strtoupper($branch->bank_branch_name)); ?></td>
								    <td><?php echo e(strtoupper($branch->bank_branch_address)); ?></td>
									<td><?php echo e(strtoupper($branch->ifsc_code)); ?></td>
									<td><a href="<?php echo e(url('editBankBranch',$branch->id)); ?>" class="btn btn-danger btn-sm">Edit</td>
...
<?php /**PATH /var/www/html/lrms/resources/views/all_bank_branch.blade.php ENDPATH**/ ?>