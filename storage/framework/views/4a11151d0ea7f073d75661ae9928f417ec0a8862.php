            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header">
                  <h4 class="card-title" style="margin-bottom:0px;">Agreement Renewed List <a class="btn btn-success btn-sm pull-right" href="<?php echo e(url('FactsList')); ?>" >Back</a></h4>
                </div>
                <div class="card-body">
                      ...
                      <thead>
                        <tr>
						 <th>Sr. No</th>
                          ...
                          <th>Rental Past History</th>
						  <th>Action Taken</th>
						  <th>Increment Times</th>
						   <th>Increment Times</th> <th>Increment Times</th> <th>Increment Times</th> <th>Increment Times</th>
                        </tr>
                      </thead>

                      <tbody>
                           <?php $i=1;?>
                        <?php $__currentLoopData = $renewedList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $renewed): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
						  <td><?php echo $i++; ?></td>
                          <td><?php echo e($renewed->factsheet_code); ?></td>
                          <td><?php echo e($renewed->total_month_rent); ?></td>
                          <td><?php echo e($renewed->revised_rent); ?></td>
						  <td><?php echo e($renewed->monthly_increase); ?></td>
						  <td><?php echo $newtext1 = wordwrap($renewed->rental_past_history, 20, "\n", true);?></td>
						  <td><?php echo $newtext2 = wordwrap($renewed->action_taken, 20, "\n", true);?></td>
						  <td><?php echo e($renewed->no_of_renewal); ?></td>
						  						  <td><?php echo e($renewed->no_of_renewal); ?></td>
						  <td><?php echo e($renewed->no_of_renewal); ?></td>
						  <td><?php echo e($renewed->no_of_renewal); ?></td>
						  <td><?php echo e($renewed->no_of_renewal); ?></td>
    ...
    $(document).ready(function() {
      ...
      $('#addRowButton').click(function() {
        ...
        $('#addRowModal').modal('hide');
          ...
          <?php /**PATH /var/www/html/lrms/resources/views/agreement_renewed_list.blade.php ENDPATH**/ ?>