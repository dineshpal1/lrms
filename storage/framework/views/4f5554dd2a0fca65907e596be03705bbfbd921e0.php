          ...
          <div class="row">
            <div class="col-md-12">
              <ul class="nav nav-tabs" id="myTab" role="tablist">
                <li class="nav-item">
                <a class="nav-link" href="<?php echo e(action('FactSheetController@view', $factSheet->id)); ?>">Fact Sheet</a>
                  <!-- <a class="nav-link active" id="home-tab" data-toggle="tab" href="<?php echo e(action('FactSheetController@view', $factSheet->id)); ?>" role="tab"
                    aria-controls="home" aria-selected="true">Fact Sheet</a> -->
                </li>
                <li class="nav-item">
                  <a class="nav-link active" href="<?php echo e(action('FactSheetController@viewnew', $factSheet->id)); ?>">Attachement</a>
                  <!-- <a class="nav-link" id="home-tab" data-toggle="tab" href="<?php echo e(action('FactSheetController@viewnew', $factSheet->id)); ?>" role="tab"
                  ...
                  <div class="card">
                   ...
                   <div class="card-header">
                     ...
                     <div class="form-group" style="text-align:center">
                      ...
                      <img src="<?php echo e(asset('uploads/factsheet_premises/'.$img)); ?>" width="200" height="100">
					  
					 <!--  <a href="<?php echo e(action('FactSheetController@downloadImage', $factSheet->id)); ?>" class="btn btn-outline-warning">Download Cover</a>
 -->
 <a href="<?php echo e(asset('uploads/factsheet_premises/'.$img)); ?>" download> Download</a>
                       <?php
                     ...
                     <br>
                        ...
                        if(!empty($ownerData))
                        {
                          ...
                          <div class="row">
                           ...
                           <img src="<?php echo e(asset('uploads/owner_cancelled_cheque/'.$owner['owner_cancelled_cheque_copy'])); ?>" width="200" height="100" alt="No Image">
                            <a href="<?php echo e(asset('uploads/owner_cancelled_cheque/'.$owner['owner_cancelled_cheque_copy'])); ?>" download> Download</a>
                            </div>
                          </div>
                        </div>
                           <hr>
                           ...
                           <div class="col-12">
                            ...
                            <div class="form-group">
                           <img src="<?php echo e(asset('uploads/owner_pan_card/'.$owner['owner_pan_card_copy'])); ?>" width="200" height="100" alt="No Image">
                           <a href="<?php echo e(asset('uploads/owner_pan_card/'.$owner['owner_pan_card_copy'])); ?>" download> Download</a>
                          </div>
                          </div>
                           </div>
                            <hr>
                          ...
                          <div class="col-12">
                            ...
                            <div class="form-group">
                           <img src="<?php echo e(asset('uploads/owner_aadhaar_card/'.$owner['owner_aadhaar_card_copy'])); ?>" width="200" height="100" alt="No Image">
                            <a href="<?php echo e(asset('uploads/owner_aadhaar_card/'.$owner['owner_aadhaar_card_copy'])); ?>" download> Download</a>
                             </div>
                          </div>
                           </div>
                          <?php  }
...
</script><?php /**PATH /var/www/html/lrms/resources/views/view_fact_sheet_new.blade.php ENDPATH**/ ?>