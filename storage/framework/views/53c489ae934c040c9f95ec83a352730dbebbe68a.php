							...
							<div class="collapse" id="tables">
								<ul class="nav nav-collapse">
									...
									<li>
									 ...
									 <?php if(Auth::user()->role_id==1 || Auth::user()->role_id==4 || Auth::user()->role_id==3): ?>
									<li>
				...
				<div class="panel-header bg-primary-gradient">
					<div class="page-inner py-5">
						<div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
							<div>
								<h2 class="text-white pb-2 fw-bold">Dashboard Of Field Staff</h2>
...
<?php /**PATH /var/www/html/lrms/resources/views/field_staff/fieldstaff_dashboard.blade.php ENDPATH**/ ?>