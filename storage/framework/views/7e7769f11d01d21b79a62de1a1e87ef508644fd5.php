            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header">
                  <h4 class="card-title">This Month Expiry Facts List  ( Total : <?php echo e($month_expiry_count); ?> )</h4>
                </div>
                <div class="card-body">
                  <div class="table-responsive">
                    <table id="basic-datatables" class="display table table-striped table-hover" >
                      ...
                      <tbody>
                           <?php $i=1;?>
                        <?php $__currentLoopData = $monthExpiryList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $facts): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
</script><?php /**PATH /var/www/html/lrms/resources/views/factsheet_month_expiry.blade.php ENDPATH**/ ?>