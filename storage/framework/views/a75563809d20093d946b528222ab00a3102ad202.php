...
.swal-button{
  background-color: green;
    ...
    <div class="main-panel">
      <div class="content">
           <!--<form name="factSheetForm" id="factSheetForm" method="POST" action="<?php echo e(url('saveFactData')); ?>">-->
...
remove member
 ...
 -->
           <!--  <form name="factSheetForm" id="factSheetForm"> -->
              <form name='form1' onsubmit="return checkform(this);" method="POST" action="<?php echo e(url('saveFactData')); ?>" enctype="multipart/form-data" id="create_form">
              <?php echo csrf_field(); ?>
 ...
 <input type="hidden" id="branch_id" name="branch_id" class="form-control" value="">
                      ...
                      <div class="row">
                       ...
                       <?php }?>
                         ...
                         <?php if($errors->has('fact_sheet_date')): ?>
                        <span class="text-danger"><?php echo e($errors->first('fact_sheet_date')); ?></span>
                        <?php endif; ?>
                         </div>  
                        ...
                        <div class="col-6">
                         ...
                         <?php if($errors->has('branch_occupancy_date')): ?>
                        <span class="text-danger"><?php echo e($errors->first('branch_occupancy_date')); ?></span>
                        <?php endif; ?>
                  ...
                  <div class="row">
                    ...
                    <div class="row">
                     ...
                     <br>
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" id="total_refundable_security_deposits" name="total_refundable_security_deposits" maxlength="10" class="form-control error" aria-required="true" value="0.0">
                          <?php if($errors->has('total_refundable_security_deposits')): ?>
                        <span class="text-danger"><?php echo e($errors->first('total_refundable_security_deposits')); ?></span>
                        ...
                        <input type="text" id="total_advances" name="total_advances" class="form-control  error" maxlength="10" aria-required="true" value="0.0">
                          <?php if($errors->has('total_advances')): ?>
                        <span class="text-danger"><?php echo e($errors->first('total_advances')); ?></span>
                     ...
                     <div class="form-group">
                        ...
                        <input type="text" id="total_month_rent" name="total_month_rent" class="form-control  error" maxlength="10" aria-required="true">
                          <?php if($errors->has('total_month_rent')): ?>
                        <span class="text-danger"><?php echo e($errors->first('total_month_rent')); ?></span>
                        ...
                        <input type="text" id="total_advance_deduction" name="total_advance_deduction" class="form-control error" aria-required="true"value="0.0">
                          <?php if($errors->has('total_advance_deduction')): ?>
                        <span class="text-danger"><?php echo e($errors->first('total_advance_deduction')); ?></span>
                   ...
                   <!--  <input type="file" class="form-control" name="factsheet_premises_photos[]" multiple /> -->
                      <input type="file" class="form-control" name="factsheet_premises_photos[]" multiple/>
                      <?php if($errors->has('factsheet_premises_photos')): ?>
                        <span class="text-danger"><?php echo e($errors->first('factsheet_premises_photos')); ?></span>
...
*/
    ...
    // $.ajax({
    //   url: "<?php echo e(url('/saveFactData')); ?>",
    //   method: 'post',
...
</script><?php /**PATH /var/www/html/lrms/resources/views/create_fact_sheet.blade.php ENDPATH**/ ?>