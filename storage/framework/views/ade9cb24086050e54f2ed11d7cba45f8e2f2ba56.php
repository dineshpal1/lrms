...
.form-group label {
  ...
  display: block;
    ...
    <div class="main-panel">
      <div class="content">
        <!--<form action="<?php echo e(url('saveFactSheetPart2')); ?>" method="post" enctype="multipart/form-data">-->
...
<span style="display: inline-block;">
					<a href="<?php echo e(action('FactSheetController@editOwnerDetails', $owner['id'])); ?>">
                      <div class="card-title" style="line-height: 0.2 !important;">Edit Owner     <?php echo e(ucfirst($owner['property_owner_name'])); ?>
...
?></h4>
                ...
                <form action="<?php echo e(url('addMoreOwnerDetails')); ?>" method="post" enctype="multipart/form-data">
        <?php echo e(csrf_field()); ?>
...
<?php /**PATH /var/www/html/lrms/resources/views/factsheet_no_of_owner.blade.php ENDPATH**/ ?>