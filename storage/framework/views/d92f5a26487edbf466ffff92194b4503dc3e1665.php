...
<div class="main-panel">
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header">
                  <h4 class="card-title">Lease Expired <a class="btn btn-success btn-sm pull-right" href="<?php echo e(url('FactsList')); ?>">Back</a></h4>
                </div>
                <div class="card-body">
                  <div class="table-responsive">
                    <table id="basic-datatables" class="display table table-striped table-hover" >
                      ...
                      <tbody>
                           <?php $i=1;?>
                        <?php $__currentLoopData = $leases; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $facts): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
						   <td><?php echo $i++; ?></td>
    ...
    <script src="<?php echo e(asset('js/dist/jquery.simplewizard.js')); ?>"></script>
    ...
    $(document).ready(function() {
      ...
      $('#addRowButton').click(function() {
        ...
        $('#addRowModal').modal('hide');
          ...
          <?php /**PATH /var/www/html/lrms/resources/views/lease_expire_one_month.blade.php ENDPATH**/ ?>