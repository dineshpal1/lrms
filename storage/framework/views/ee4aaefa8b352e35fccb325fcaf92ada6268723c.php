    ...
    <div class="main-panel">
      <div class="content">
           ...
           <!--  <form name="factSheetForm" id="factSheetForm"> -->
              <form name='form2'  method="POST" action="<?php echo e(url('saveBanks')); ?>" id="add_banks">
              <?php echo csrf_field(); ?>
            ...
            <div class="col-md-6">
              <ul class="nav nav-tabs" id="myTab" role="tablist">
                <li class="nav-item">
                  <a class="nav-link active" id="home-tab" data-toggle="tab" href="#home" role="tab"
                    aria-controls="home" aria-selected="true">Add Bank </a>
             ...
             <div class="row">
                     ...
                     <div class="form-group">
                        <label for="name">Add Bank</label>
                  
                      <input type="text" class="form-control" name="bank_name" style="text-transform: uppercase" />
                     ...
                     <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="add_ifsc" style="text-transform: uppercase" />
        ...
        <br/>
           <div class="card-action">
                      ...
                      <button type="button" class="btn btn-danger" onClick="window.location='<?php echo e(url("allBank")); ?>'" >Cancel</button>
...
function ValidationEvent() {
 ...
 </script><?php /**PATH /var/www/html/lrms/resources/views/add_bank.blade.php ENDPATH**/ ?>